        ...
        <div class="container" style="background-color: brown; color: white">
        	<div id="forms" >
	        	<div class="col-md-12">
		        	...
		        	<form id="tesform" name="movieForm" enctype="multipart/form-data"  class="form-group needs-validation" action="{{ route('addfilm') }}" method="POST">
		            	@csrf
                        <div class="row">
		                    <div class="col-md-7 mb-3 @error('title') is-invalid @enderror">
		                    	<label for="title">Title</label>
		                        <input type="text" id="title" value="{{ old('title')}}" name="title" class="form-control" ng-minlength="1" placeholder="*required" required>
                                @error('title')
		                    ...
		                    <div class="col-md-5 mb-3 @error('genre') is-invalid @enderror" >
								...
								<input type="text" id="genre" name="genre" class="form-control" ng-minlength="1" value="{{ old('genre')}}"  placeholder="*required" required>
                                @error('genre')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                ...
		                <div class="row">
							<div class="col-md-2 mb-3 @error('language') is-invalid @enderror" >
								...
								<input type="text" id="language" name="language" class="form-control" ng-minlength="1" value="{{ old('language')}}"  placeholder="*required" required>
                                @error('language')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                    ...
		                    <div class="col-md-2 mb-3 @error('runtime') is-invalid @enderror" >
		                        ...
		                        <input type="text" id="runtime" name="runtime" class="form-control" ng-minlength="2" value="{{ old('runtime')}}" placeholder="*required" required>
                                @error('runtime')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                    ...
		                    <div class="col-md-8 mb-3 @error('producer') is-invalid @enderror" >
		                        ...
		                        <input type="text" id="producer" name="producer" class="form-control" ng-minlength="1" value="{{ old('producer')}}" placeholder="*required" required>
                                @error('producer')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                ...
		                <div class="row">
		                	<div class="col-md-3 mb-3 @error('director') is-invalid @enderror" >
		                        ...
		                        <input type="text" id="director" name="director" class="form-control" ng-minlength="1" value="{{ old('director')}}" placeholder="*required" required>
								@error('director')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                    ...
		                    <div class="col-md-5 mb-3 @error('distributor') is-invalid @enderror" >
		                        ...
		                        <input type="text" id="distributor" name="distributor" class="form-control" ng-minlength="1" value="{{ old('distributor')}}" placeholder="*required" required>
								@error('distributor')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                    ...
		                    <div class="col-md-2 mb-3 @error('year') is-invalid @enderror" >
		                        ...
		                        <input type="number" id="year" name="year" class="form-control" ng-minlength="4" value="{{ old('year')}}" placeholder="*required" required>
								@error('year')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                    ...
		                    <div class="col-md-2 mb-3 @error('rating') is-invalid @enderror" >
	                            ...
	                            document.getElementById("rating").value = "{{old('rating')}}";
	                            </script>
								@error('rating')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
		                ...
		                <div class="row">
		                	<div class="col-md-12 mb-3 @error('casts') is-invalid @enderror" >
		                        ...
		                        <textarea id="casts" name="casts" class="form-control" ng-minlength="1"   placeholder="*required" rows="1" required>{!! old('casts')!!}</textarea>
								@error('casts')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                    ...
		                    <div class="col-md-12 mb-3 @error('synopsisshort') is-invalid @enderror" >
		                        ...
		                        <textarea id="synopsisshort" name="synopsisshort" class="form-control" ng-minlength="1"  placeholder="*required" rows="2" required>{!! old('synopsisshort')!!}</textarea>
								@error('synopsisshort')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                ...
		                <div class="row">
		                	<div class="col-md-12 mb-3 @error('synopsisline1') is-invalid @enderror" >
		                        ...
		                        <textarea id="synopsisline1" name="synopsisline1" class="form-control" ng-minlength="1"  placeholder="*required" rows="5" required>{!! old('synopsisline1')!!}</textarea>
								@error('synopsisline1')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
		                    ...
		                    <div class="col-md-12 mb-3">
		                        ...
		                        <textarea id="synopsisline2" name="synopsisline2"  class="form-control" rows="5">{!! old('synopsisline2')!!}</textarea>
							</div>
						</div>
		                <div class="row">
		                	<div class="col-md-6 mb-3 @error('videourl') is-invalid @enderror" >
		                    	<label for="videourl">Video URL</label>
		                        <input type="text" id="videourl" name="videourl" class="form-control" ng-minlength="1" value="{{ old('videourl')}}"  placeholder="*required" required>
								@error('videourl')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
						...
						<div class="d-flex justify-content-center col-md-12 mb-6">
		                	<ul class="row list-inline">
								...
								<li class="list-inline-item">
									<button id="clearBtn" class="btn btn-block" type="reset" value="Clear form" style="color: white" name="clearBtn">Clear form</button>
								</li>
								<li class="list-inline-item">
